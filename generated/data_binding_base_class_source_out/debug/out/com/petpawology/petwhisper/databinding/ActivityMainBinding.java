...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final FloatingActionButton floatPetButton;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Toolbar AppBar,
      @NonNull FrameLayout MainFrameContainer, @NonNull BottomNavigationView bottomNavigation,
      @NonNull FloatingActionButton floatPetButton, @NonNull ConstraintLayout main,
    ...
    this.floatPetButton = floatPetButton;
    this.main = main;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.floatPetButton;
      FloatingActionButton floatPetButton = ViewBindings.findChildViewById(rootView, id);
      if (floatPetButton == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, AppBar, MainFrameContainer,
          bottomNavigation, floatPetButton, main, profileImage, toolbarTitle);
    }
